...
export const apiSuccessResponseInterceptor = (
  ...
  return {
    ...response,
    // IA: for some reason, Axios doesn’t set responseMeta (maybe a version upgrade?),
    // whereas the Appsmith codebase clearly expects it. Let’s add this prop manually
    responseMeta: {
