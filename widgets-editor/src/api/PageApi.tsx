...
class PageApi extends Api {
  ...
  static fetchPage(
    ...
    return Api.get(
      "https://gist.githubusercontent.com/iamakulov/74704b2a2fae2626ced1f24e518ca062/raw/1240ff108da5251b18126ab6ee77229dae737c34/fetchPage.json",
      {},
  ...
  static async savePage(
    ...
    const response = await Api.get(
      "https://gist.githubusercontent.com/iamakulov/74704b2a2fae2626ced1f24e518ca062/raw/1240ff108da5251b18126ab6ee77229dae737c34/savePage.json",
      {},
      { withCredentials: false },
    );
    response.data.dsl = _.cloneDeep(savePageRequest.dsl);
  ...
  static fetchPageList(
    ...
    // IA: mock the API response
    return Api.get(
      "https://gist.githubusercontent.com/iamakulov/74704b2a2fae2626ced1f24e518ca062/raw/1240ff108da5251b18126ab6ee77229dae737c34/fetchPageList.json",
      {},
      { withCredentials: false },
    );
  }
