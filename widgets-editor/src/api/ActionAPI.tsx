...
class ActionAPI extends API {
  ...
  static fetchActions(
    ...
    return API.get(
      "https://gist.githubusercontent.com/iamakulov/74704b2a2fae2626ced1f24e518ca062/raw/84af4309916dd208785b3f600a0edb8b370ddc0e/fetchActions.json",
      {},
  ...
  static executeAction(
    ...
    // IA: mock the API response
    return API.get(
      "https://gist.githubusercontent.com/iamakulov/74704b2a2fae2626ced1f24e518ca062/raw/3b477c9cd849b823672099b2b8330d39643e557d/executeAction_githubMock.json",
      {},
      { withCredentials: false },
    );
  }
